"""Local-model candidate: gpt-oss:20b served by Ollama's OpenAI-compatible
API - the OpenAI-offline cell for WI-LLM-0056's tranche 1 (Apache 2.0,
native Ollama MXFP4 support - https://ollama.com/blog/gpt-oss).
...
Usage:
    python lcats/experimental/model_comparison/ollama_gpt_oss_20b/benchmark.py
"""
