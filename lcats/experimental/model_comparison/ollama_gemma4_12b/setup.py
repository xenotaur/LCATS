"""Prerequisite check for the ollama_gemma4_12b candidate. Run before benchmark.py.

Verifies the Ollama server is reachable and the gemma4:12b model has been
