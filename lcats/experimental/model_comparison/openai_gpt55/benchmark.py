"""OpenAI online candidate: gpt-5.5 via OpenAIBackend (real OpenAI API).

Run setup.py first. This makes ONE real, billable OpenAI API call (the
...
Usage:
    python lcats/experimental/model_comparison/openai_gpt55/benchmark.py
"""
