"""Prerequisite check for the ollama_deepseek_r1_14b candidate. Run before benchmark.py.

Verifies the Ollama server is reachable and the deepseek-r1:14b model has
