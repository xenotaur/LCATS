...
def word_count(text: str) -> int:
    """Count words in text using a simple split-based tokenizer.

    Using string.split() for basic whitespace tokenization avoids regex
    evaluation overhead and is significantly faster than re.findall(r'\\S+').
    """
