...
GRIMM_HEADINGS = [
    ...
    (
        "fisherman_and_his_wife",
        "THE FISHERMAN AND HIS WIFE",
        "Grimm - the Fisherman And His Wife",
    ),
    (
        "willow-wren_and_the_bear",
    ...
    (
        "adventures_of_chanticleer_and_partlet",
    ...
    (
        "story_of_the_youth_who_went_forth_to_learn_what_fear_was",
...
def gather():
    ...
    gatherlib.gather(
        ...
        author="Grimm",
        year=1812,
        headings=GRIMM_HEADINGS,
        gutenberg_url=GRIMM_GUTENBERG,
        paragraph_finder=find_paragraphs_grimmfairytales,
    )
