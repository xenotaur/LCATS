...
EXCLUDED_SUBJECTS = [
    ...
    # Eliminates story 23923 which should be revisted
    "spelling reform",
]


# Words in titles that indicate the work is not a single short story.
EXCLUDED_TITLE_PART_WORDS = ["part", "volume", "book", "chapter", "vol."]
...
EXCLUDED_TITLE_WORDS = [
    ...
    "poem",
    # Kills one story which is unworkable.
    "a political romance",
]


# Single stories we have determined are useful for our corpus.
SINGLE_STORIES = sorted(
    [
        10001,
        10393,
        10618,
