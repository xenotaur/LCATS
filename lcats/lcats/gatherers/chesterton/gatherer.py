...
CHESTERTON_HEADINGS = [
    ...
    ('honour_of_israel_gow', 'The Honour of Israel Gow',
     'Chesterton - The Honour Of Israel Gow'),
    ('wrong_shape', 'The Wrong Shape', 'Chesterton - The Wrong Shape'),
    ('sins_of_prince_saradine', 'The Sins of Prince Saradine',
    ...
    ('sign_of_the_broken_sword', 'The Sign of the Broken Sword',
     'Chesterton - The Sign Of the Broken Sword'),
    ('three_tools_of_death', 'The Three Tools of Death',
