...
CHESTERTON_HEADINGS = [
    ...
    ('honour_of_israel_gow', 'The Honour of Israel Gow', 'Chesterton - The Honour Of Israel Gow'),
    ('wrong_shape', 'The Wrong Shape', 'Chesterton - The Wrong Shape'),
    ('sins_of_prince_saradine', 'The Sins of Prince Saradine', 'Chesterton - The Sins Of Prince Saradine'),
    ('hammer_of_god', 'The Hammer of God', 'Chesterton - The Hammer Of God'),
    ('eye_of_apollo', 'The Eye of Apollo', 'Chesterton - The Eye Of Apollo'),
    ('sign_of_the_broken_sword', 'The Sign of the Broken Sword', 'Chesterton - The Sign Of the Broken Sword'),
    ('three_tools_of_death', 'The Three Tools of Death', 'Chesterton - The Three Tools Of Death')
]
    
def find_paragraphs_chestertonfairytales(soup, start_heading_text):
...
def create_download_callback(story_name, url, start_heading_text, description):
    ...
    def story_download_callback(contents):
        ...
        story_text = find_paragraphs_chestertonfairytales(story_soup, start_heading_text)
