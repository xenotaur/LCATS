# Corpus analysis subsystem architecture

Extracted from `lcats/src/lcats/analysis/corpus/README.md` (sections 1-8),
which now carries a short pointer here instead. See that file for the
corpus package's usage-oriented content (`lcats assess`), which stayed in
place since it links to `docs/how-to/run-assess.md` and
...
- [`lcats/src/lcats/analysis/corpus/README.md`](../../src/lcats/analysis/corpus/README.md) — the package README this content was extracted from; still covers `lcats assess` usage.
- [`docs/how-to/run-assess.md`](../how-to/run-assess.md) — using `lcats assess`.
- [`docs/reference/cli-commands.md`](../reference/cli-commands.md) — full CLI flag reference.
